...
import SearchFormComponent from "../UIComponents/SearchFormComponent";

import ExpandableComponent from "./EC";

const Home = () => <Text style={styles.header}>Default route to be show</Text>;

export function RenderSearchOrderForm({ routes }) {
  return (
    <View>
      <View style={styles.nav}>
        <Row>
          <SearchFormComponent
            api={`/v1/schema/singleformLayout`}
            requestMethod={`POST`}
            requestBody={{
            ...
            redirectRoute={`/search-order/list`}
          />
        </Row>
      </View>
      {routes.map((route, i) => (
...
export function RenderSearchOrderList(props) {
  return (
    <View>
      <Row>
...
export function RenderOrderDetailView({ match, routes }) {
  return (
...
export function OrderLineDetailView({ match }) {
  return (
    <View style={styles.container}>
      <Row>
        <Col
