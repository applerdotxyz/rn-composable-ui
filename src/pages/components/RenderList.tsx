...
export default function RenderList({data, searchFields, visibleKeys, titleStyle, dataStyle}) {
            ...
            <TouchableOpacity key={d.id}>
              <View style={{ flexDirection: "row" }}>
                ...
                keys.length ? keys.map((key, i) => (
                    ...
                    <Text numberOfLines={2}  ellipsizeMode='tail' style={[styles.tableVal, dataStyle]}>{d[key]} </Text>
                )) : null
                }
              </View>
            </TouchableOpacity>
