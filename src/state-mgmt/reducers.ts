...
import { LOGIN_FAILURE, LOGIN_SUCCESS, LOGOUT_SUCCESS } from "./actions"; //Import the actions types constant we defined in our actions
...
if (process.env.REACT_NATIVE_NODE_ENV !== "stage") {
  ...
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  environment = require("../config/env.stage").default;
}
